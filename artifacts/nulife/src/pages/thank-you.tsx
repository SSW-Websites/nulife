...
function CircleNode({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex-1 aspect-square max-w-[200px] rounded-full border-[1.81px] border-neutral-600 bg-transparent flex items-center justify-center p-3 sm:p-4 md:p-5">
